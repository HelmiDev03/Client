  ...
  return (
    ...
    <div className="flex flex-row justify-between items-center mb-6">
        <div className="w-[324px]    flex flex-row justify-start">
            <div className='hover:cursor-pointer'><Image alt='image' style={{  position :'relative' ,   borderRadius: '10px' , width : '100px' , height:'100px' , marginRight: '10px' }} width={100} height={100}  src="/women.png" /></div>
