        ...
        <div className={styles.ProfileContainer}>
            ...
            <div className="flex flex-row justify-between height-auto ">
                <div className="flex flex-col justify-center items-start w-[242px] h-[167px] mr-3 mt-[-15px]  rounded-[10px]  bg-opacity-[20%] bg-white-500">
                    <h3 onClick={()=>router.push('/profile')} className={` p-3  flex justify-start items-center font-lexendfont-light flex text-[16px] rounded-[10px]  w-[100%] leading-[24px] mb-2 hover:cursor-pointer  ${(pathname==='/profile' || pathname==='/profile/personalinformation' || pathname==='/profile/professionelInformation' || pathname==='/profile/security') ? ' text-[#eee] bg-[#7152F3]' : ' text-[#16151C]'}                    `}><IoPersonOutline className="text-[20px] mr-3" /> Profile</h3>
