    ...
    return (
        <div className={styles.container}>
            ...
            <div style={{ boxShadow: "inset 0 0 10px 0 rgba(0, 0, 0, 0.1)" }} className={` ${PopupAddPolicy ? 'block' : 'hidden'}           p-4 z-10 bg-[#eee] shadow-lg  absolute w-[500px] translate-x-[300px]  translate-y-[100px] center rounded-[25px] `}>
                <IoMdClose onClick={() => setPopupAddPolicy(!PopupAddPolicy)} className='absolute right-[5%] text-[24px] hover:cursor-pointer' />
            ...
            <div className='flex flex-wrap flex-row mb-[30px]'>
                <div className='relative w-[550px] mr-6 flex flex-col border border-gray-300 p-2 '>
                ...
                {policies.map((policy: any, index: any) => (
                    <div key={policy.name} className='relative w-[550px] mr-6 flex flex-col border border-gray-300 p-2'>
                        <FaSquarePen className='absolute right-[50%] top-[-10%] text-[30px] text-gray-600 ' />
                        <div className='flex flex-row justify-between'>
                            <div className='rounded-[5px] h-[30px] flex justify-center items-center bg-[#7152F3]'>
                                <h1 className='text-[#fff] font-lexend font-semibold text-[20px] leading-[30px]'>{policy.name}</h1>
                            </div>
                            <IoMdSettings onClick={() => setisulhidden(!isulhidden)} className='relative text-[24px] text-[#7152F3] hover:cursor-pointer mb-4' />
                            {!isulhidden && (
                        ...
                        <div className='flex flex-col justify-center items-center border-b border-gray-300'>
                            {policy.isdefault && <h1 className='text-[#16151C] font-lexend font-light text-[20px] leading-[30px] '>default</h1>}
                           
                                <p className='text-[#16151C] font-lexend font-light text-[14px] leading-[22px] mb-4'>
                                    {Object.keys(policy.employees).length} employees
                                </p>
