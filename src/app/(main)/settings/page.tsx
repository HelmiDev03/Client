...
const Settings = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap justify-center mt-5'>
        ...
        <div  onClick={()=>router.push('/settings/timeoff')}  className='flex flex-col justify-center items-center h-[200px] w-[350px]  mr-[44px] mb-[44px]  bg-[#dedede] rounded-[36px] hover:cursor-pointer'>
