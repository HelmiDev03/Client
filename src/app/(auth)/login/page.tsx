                ...
                <div className={`signup-section flex flex-col mt-8 mb-4  justify-center items-center  h-[200px] bg-white-500 rounded-[10px] pt-[5px] `}>
                    <form className='mb-12'>
                        ...
                        <div className='flex flex-col justify-between items-center '>
                            ...
                            {errorMessage && <div className=" h-[30px] w-[445px] flex justify-center items-center p-4 text-sm text-red-800 border border-red-300 rounded-lg bg-red-200 " role="alert">
                            <svg className="flex-shrink-0 inline w-4 h-4 me-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z" />
                            </svg>
                            <span className="sr-only">Info</span>
                    ...
                    <button onClick={Loginfct} disabled={loading} className='mb-4 w-full flex justify-center items-center rounded-xl p-3 bg-[#115DFC] hover:bg-[#6790eb] disabled:bg-[#6790eb] disabled:cursor-none' >
